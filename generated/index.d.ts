...
export namespace Prisma {
  ...
  */
  ...
  export interface Prisma__PaymentEventClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: "PrismaPromise"
    transaction<T extends PaymentEvent$transactionArgs<ExtArgs> = {}>(args?: Subset<T, PaymentEvent$transactionArgs<ExtArgs>>): Prisma__TransactionClient<$Result.GetResult<Prisma.$TransactionPayload<ExtArgs>, T, "findUniqueOrThrow", GlobalOmitOptions> | null, null, ExtArgs, GlobalOmitOptions>
    /**
     * Attaches callbacks for the resolution and/or rejection of the Promise.
     * @param onfulfilled The callback to execute when the Promise is resolved.
     * @param onrejected The callback to execute when the Promise is rejected.
  ...
  interface PaymentEventFieldRefs {
    ...
    readonly processed: FieldRef<"PaymentEvent", 'Boolean'>
   ...
   */
  export type PaymentEvent$transactionArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * Select specific fields to fetch from the Transaction
     */
    select?: TransactionSelect<ExtArgs> | null
  ...
  export type PaymentEventScalarWhereWithAggregatesInput = {
    ...
    processed?: BoolWithAggregatesFilter<"PaymentEvent"> | boolean
  ...
  export type PaymentEventUpdateInput = {
    ...
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
    transaction?: TransactionUpdateOneWithoutEventsNestedInput
  }
  ...
  export type PaymentEventCreateNestedManyWithoutTransactionInput = {
  ...
  export type PaymentEventUpdateManyWithoutTransactionNestedInput = {
    create?: XOR<PaymentEventCreateWithoutTransactionInput, PaymentEventUncheckedCreateWithoutTransactionInput> | PaymentEventCreateWithoutTransactionInput[] | PaymentEventUncheckedCreateWithoutTransactionInput[]
    connectOrCreate?: PaymentEventCreateOrConnectWithoutTransactionInput | PaymentEventCreateOrConnectWithoutTransactionInput[]
    upsert?: PaymentEventUpsertWithWhereUniqueWithoutTransactionInput | PaymentEventUpsertWithWhereUniqueWithoutTransactionInput[]
    createMany?: PaymentEventCreateManyTransactionInputEnvelope
  ...
  export type TransactionUpdateOneWithoutEventsNestedInput = {
    create?: XOR<TransactionCreateWithoutEventsInput, TransactionUncheckedCreateWithoutEventsInput>
    connectOrCreate?: TransactionCreateOrConnectWithoutEventsInput
  ...
  export type PaymentEventCreateOrConnectWithoutTransactionInput = {
    where: PaymentEventWhereUniqueInput
    create: XOR<PaymentEventCreateWithoutTransactionInput, PaymentEventUncheckedCreateWithoutTransactionInput>
  }

  export type PaymentEventCreateManyTransactionInputEnvelope = {
    data: PaymentEventCreateManyTransactionInput | PaymentEventCreateManyTransactionInput[]
    skipDuplicates?: boolean
  }
  ...
  export type PaymentEventUpsertWithWhereUniqueWithoutTransactionInput = {
    where: PaymentEventWhereUniqueInput
    update: XOR<PaymentEventUpdateWithoutTransactionInput, PaymentEventUncheckedUpdateWithoutTransactionInput>
    create: XOR<PaymentEventCreateWithoutTransactionInput, PaymentEventUncheckedCreateWithoutTransactionInput>
  }

  export type PaymentEventUpdateWithWhereUniqueWithoutTransactionInput = {
    where: PaymentEventWhereUniqueInput
    data: XOR<PaymentEventUpdateWithoutTransactionInput, PaymentEventUncheckedUpdateWithoutTransactionInput>
  }

  export type PaymentEventUpdateManyWithWhereWithoutTransactionInput = {
    where: PaymentEventScalarWhereInput
    data: XOR<PaymentEventUpdateManyMutationInput, PaymentEventUncheckedUpdateManyWithoutTransactionInput>
  }
